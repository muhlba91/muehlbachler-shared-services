...
require (
	github.com/muhlba91/pulumi-shared-library v0.0.0-20260723090508-8ad6ad43088a
	github.com/pulumi/pulumi-aws/sdk/v7 v7.38.0
...
require (
	...
	github.com/pulumi/pulumi-vault/sdk/v7 v7.11.0 // indirect
